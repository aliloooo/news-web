      ...
      <div className="container-main py-8 md:py-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            <img className="h-8 w-auto opacity-90" src="/logonews.png" alt="Logo" />
            <span className="text-sm font-semibold text-gray-400 tracking-wide uppercase">NewsWeb</span>
          </div>

          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} NewsWeb. All Rights Reserved.
          </p>

          <div className="flex items-center space-x-6">
            <a href="https://github.com/aliloooo" className="text-gray-400 hover:text-gray-900 transition-colors" aria-label="Github">
            ...
            <a href="https://instagram.com/alrahmaniimmortal" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-pink-600 transition-colors" aria-label="Instagram">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
