  ...
  return (
    <div>
      <div className="mb-8 border-b border-gray-200 pb-5">
        <h1 className="text-3xl font-bold text-gray-900">Programming News</h1>
        <p className="mt-2 text-gray-500">Tech, coding, and development updates</p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12">
          <p className="text-gray-500 text-lg">No programming news found.</p>
        </div>
      )}
    </div>
  );
